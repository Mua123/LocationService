...
public class GenCRC {
	static final char crctab16[] = { 0X0000, 0X1189, 0X2312, 0X329B, 0X4624, 0X57AD, 0X6536, 0X74BF, 0X8C48, 0X9DC1,
	...
	public static char getCrc16(byte[] pData) {				//计算CRC算法
		char fcs = 0xffff;
		for (int i = 0; i < pData.length; i++) {
			fcs = (char) ((fcs >>> 8) ^ crctab16[(fcs ^ pData[i]) & 0xff]);
//			System.out.print("一次校验码" + Integer.toHexString((fcs >> 8) & 0xff));
//			System.out.println(Integer.toHexString((fcs) & 0xff));
		}
		return (char) ~fcs;
	}
}
